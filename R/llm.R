...
#
# HTTP providers use `httr2` + `jsonlite`. All public functions are
# prefixed `morie_llm_*` and exported. Streaming is not supported in
# this R port (always returns the full string).
