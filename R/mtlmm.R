...
#'
#' Formula: Y = (1 (x) I_T) mu + X beta + Z b + eps,  b ~ N(0, G (x) Sigma_T),  eps ~
#' N(0, I_J (x) R_T)
#'
...
#' doi:10.1007/978-3-030-89010-0.  Chapter 5, Eq. (5.5)/(5.5a) p. 153: the traits of each
#' line are stacked, giving a mixed model with Kronecker-structured covariances.  The
...
#' traits, line 2 traits, ...).  Delegates to the chapter routine in morie.fn._gp_core,
#' which was verified against this book in the earlier tranches of this shelf recorded in
