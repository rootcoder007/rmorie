...
#' @param slope Slope applied below the threshold; 0 gives the plain ReLU, a small
#' positive value gives the leaky ReLU of Sect. 10.3.3.
#'
...
#' doi:10.1007/978-3-030-89010-0.  Chapter 10, Sect. 10.3.2 p. 388: g(z) = max(0, z),
#' flat below the threshold and linear above it; Sect. 10.3.3 p. 389 gives the leaky
#' variant with slope alpha below zero (the figure uses alpha = 0.1).  Read from the
