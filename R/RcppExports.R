...
#' Internal helper: Rmorie Sodium Available Impl
#' @noRd
.rmorie_sodium_available_impl <- function() {
    .Call(`_rmorie_morie_crypto_sodium_available`)
}

#' Internal helper: Rmorie Sodium Version Impl
#' @noRd
...
#' Internal helper: Rmorie Hkdf Sha256 Impl
#' @noRd
...
#' Internal helper: Rmorie Random Bytes Impl
#' @noRd
