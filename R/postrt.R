...
#'
#' Formula: \eqn{w_i' = w_i N_h / sum_{j in h} w_j}; the estimate is the
#' weighted mean
#'
...
#' @export
#' @examples
#' Postrt(y = c(1, 2, 3, 4, 5, 6, 7, 8), weights = c(1, 2, 3, 4, 5, 6, 7, 8),
#'   stratum = c(1, 2, 3, 4, 5, 6, 7, 8), N_h = c(1, 2, 3, 4, 5, 6, 7, 8))
