...
#' @examples
#' \dontshow{if (nzchar(system.file("extdata", "montreal_sim_interventions_sample.csv",
#'   package = "rmorie")) ||
...
#'   `Description`.
#' @examples
#' \dontshow{if (nzchar(system.file("extdata", "montreal_sim_intervention_types.csv",
#'   package = "rmorie")) ||
#'   requireNamespace("rmoriedata", quietly = TRUE)) withAutoprint(\{ # examplesIf}
