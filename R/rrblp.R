...
#' doi:10.1007/978-3-030-89010-0.  Chapter 2, Eq. (2.4) p. 53: SNP-BLUP replaces Z by the
#' scaled marker matrix M and Sigma by sigma2_M I in Eq. (2.2); the genomic estimated
#' breeding value is M uhat.  Delegates to the chapter routine in morie.fn._gp_core,
